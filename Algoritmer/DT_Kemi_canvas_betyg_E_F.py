...
DATUM: 12-15, efter ett halvår alltså.
- Ämne: Kemi
...
dt = DecisionTreeClassifier(criterion = 'gini', min_samples_split = 4, min_samples_leaf = 1, random_state=10, max_depth=5)
...
fig.savefig('DT_kemi_canvas_E_F_0.3test_minsample=1.png')
